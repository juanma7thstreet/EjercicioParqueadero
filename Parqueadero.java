...
// -----------------------------------------------------------------
    ...
    //2.1 Retorna cuánto tiempo llevan en promedio los carros en el parqueadero.
    ...
    //2.2 Retorna el carro que ha estado durante más horas en el parqueadero
    ...
    //2.3 Retorna un valor boolean indicando si hay un carro que lleve más de 8 horas parqueado
    ...
    //2.4 Retorna en un ArrayList todos los carros que llevan más de tres horas parqueados
    ...
    //2.5 Retorna un valor boolean indicando si hay dos carros parqueados con la misma placa
    ...
    // 3.1 Cuenta carros parqueados cuya placa comienza por "PB"
    ...
    // 3.2 Verifica si hay un carro que lleva más de 24 horas parqueado
    ...
    // 3.4 Desocupa el parqueadero y retornar la cantidad de carros sacados
